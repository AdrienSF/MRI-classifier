...
# selected_feature_indexes = np.where(pca.components_[0] > .15)[0]

# get the indexes of the feature that contribute most to the first 30 pricipal components
# selected_feature_indexes = np.array([np.argmax(pca.components_[i]) for i in range(30)])
...
selected_feature_indexes = np.array(list(set(indexes)))


# compare with all features:
# selected_feature_indexes = list(range(69))
...
models_to_try = [try_random_forest, try_adaboost]
